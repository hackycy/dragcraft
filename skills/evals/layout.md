...
workflows:
  - layout
task: 为页面加入固定页头、正文和浮层操作，让 Designer 通过 PresentationFrame、DesignerViewportPortal 与 useSurfaceReservation 保持现有交互，并让独立 Vue 运行时按 DocumentSchema 和稳定 type 自主解释展示。
evidence:
