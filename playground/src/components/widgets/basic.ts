  ...
  formSchema: {
    sections: [
      ...
      },
      {
        ...
        fields: [
          { key: 'fontSize', label: '字号', labelKey: 'widget.text.field.fontSize.label', component: 'number', defaultValue: 14, props: { min: 10, max: 72 } },
          {
            key: 'fontWeight',
            label: '字重',
    ...
    sections: [
      {
        ...
        fields: [
          { key: 'text', label: '按钮文字', labelKey: 'widget.button.field.text.label', placeholderKey: 'widget.button.field.text.placeholder', component: 'input', defaultValue: '按钮', props: { placeholder: '请输入按钮文字' } },
          {
            key: 'type',
            label: '按钮类型',
            ...
            component: 'select',
            defaultValue: 'button',
            props: { options: [{ label: '普通按钮', value: 'button' }, { label: '提交按钮', value: 'submit' }, { label: '重置按钮', value: 'reset' }] },
          },
          {
            key: 'size',
            label: '按钮尺寸',
            ...
            component: 'select',
            defaultValue: 'medium',
            props: { options: [{ label: '小', value: 'small' }, { label: '中', value: 'medium' }, { label: '大', value: 'large' }] },
          },
    ...
    sections: [
      {
        ...
        fields: [
          { key: 'src', label: '图片地址', labelKey: 'widget.image.field.src.label', placeholderKey: 'widget.image.field.src.placeholder', component: 'input', defaultValue: '', props: { placeholder: '请输入图片 URL' } },
          { key: 'alt', label: '替代文本', labelKey: 'widget.image.field.alt.label', placeholderKey: 'widget.image.field.alt.placeholder', component: 'input', defaultValue: '', props: { placeholder: '图片无法显示时的替代文本' } },
          {
            key: 'objectFit',
            label: '填充方式',
            ...
            props: { options: [{ label: '包含', value: 'contain' }, { label: '覆盖', value: 'cover' }, { label: '拉伸', value: 'fill' }, { label: '原始', value: 'none' }] },
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        fields: [
          { key: 'text', label: '链接文字', labelKey: 'widget.link.field.text.label', placeholderKey: 'widget.link.field.text.placeholder', component: 'input', defaultValue: '链接', props: { placeholder: '请输入链接文字' } },
          { key: 'href', label: '链接地址', labelKey: 'widget.link.field.href.label', component: 'input', defaultValue: '#', props: { placeholder: 'https://example.com' } },
          {
            key: 'target',
            label: '打开方式',
            ...
            component: 'select',
            defaultValue: '_self',
            props: { options: [{ label: '当前窗口', value: '_self' }, { label: '新窗口', value: '_blank' }] },
          },
        ...
        fields: [
          {
            ...
            props: { options: [{ label: '水平', value: 'horizontal' }, { label: '垂直', value: 'vertical' }] },
          },
          { key: 'color', label: '颜色', labelKey: 'widget.divider.field.color.label', component: 'color', defaultValue: '#e8e8e8' },
          { key: 'thickness', label: '粗细', labelKey: 'widget.divider.field.thickness.label', component: 'number', defaultValue: 1, props: { min: 1, max: 10 } },
        ],
      },
    ],
  },
