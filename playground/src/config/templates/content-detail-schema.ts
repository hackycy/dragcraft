          ...
          regions: {
            default: [
              ...
              },
              {
                id: 'body-1',
                type: 'text',
                props: { content: 'Dragcraft 是一个面向小程序装修场景的可视化页面搭建引擎。采用 Core Engine + Vue Visual Builder Workbench + Standard Workbench Theme 架构，构建核心与 UI 分离的页面设计引擎。', fontSize: 15, fontWeight: 'normal', color: '#333333', textAlign: 'left' },
