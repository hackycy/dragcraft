...
export interface NodeSelectionProjection {
  ...
  /** NodeHost border box relative to the registered plane. */
  nodeBounds: NodeSelectionRect
  /** Presentation-owned visual selection bounds relative to the registered plane. */
